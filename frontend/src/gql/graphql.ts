...
export type CkbAddressQuery = { __typename?: 'Query', ckbAddress?: { __typename?: 'CkbAddress', transactions: Array<{ __typename?: 'CkbTransaction', isCellbase: boolean, blockNumber: number, hash: string, fee: number, size: number, feeRate: number, confirmations: number, inputs: Array<{ __typename?: 'CkbCell', txHash: string, index: number, capacity: number, status: { __typename?: 'CkbCellStatus', consumed: boolean, txHash?: string | null, index?: number | null }, type?: { __typename?: 'CkbScript', codeHash: string, hashType: string, args: string } | null, lock: { __typename?: 'CkbScript', codeHash: string, hashType: string, args: string }, xudtInfo?: { __typename?: 'CkbXUDTInfo', symbol: string, amount: string, decimal: number, typeHash: string } | null }>, outputs: Array<{ __typename?: 'CkbCell', txHash: string, index: number, capacity: number, type?: { __typename?: 'CkbScript', codeHash: string, hashType: string, args: string } | null, lock: { __typename?: 'CkbScript', codeHash: string, hashType: string, args: string }, xudtInfo?: { __typename?: 'CkbXUDTInfo', symbol: string, amount: string, decimal: number, typeHash: string } | null, status: { __typename?: 'CkbCellStatus', consumed: boolean, txHash?: string | null, index?: number | null } }>, block: { __typename?: 'CkbBlock', timestamp: any, number: number } }> } | null };
...
export type BtcBlockTransactionQuery = { __typename?: 'Query', btcBlock?: { __typename?: 'BitcoinBlock', transactions: Array<{ __typename?: 'BitcoinTransaction', blockHeight: number, blockHash: string, txid: string, version: number, size: number, locktime: number, weight: number, fee: number, feeRate: number, confirmed: boolean, vout: Array<{ __typename?: 'BitcoinOutput', scriptpubkey: string, scriptpubkeyAsm: string, scriptpubkeyType: string, scriptpubkeyAddress?: string | null, value: number, status: { __typename?: 'BitcoinOutputStatus', spent: boolean, txid?: string | null, vin?: number | null }, address?: { __typename?: 'BitcoinAddress', address: string, satoshi: number, pendingSatoshi: number, transactionsCount?: number | null } | null }>, vin?: Array<{ __typename?: 'BitcoinInput', txid: string, vout: number, scriptsig: string, scriptsigAsm: string, isCoinbase: boolean, sequence: number, prevout?: { __typename?: 'BitcoinOutput', scriptpubkey: string, scriptpubkeyAsm: string, scriptpubkeyType: string, scriptpubkeyAddress?: string | null, value: number, status: { __typename?: 'BitcoinOutputStatus', spent: boolean, txid?: string | null, vin?: number | null }, address?: { __typename?: 'BitcoinAddress', address: string, satoshi: number, pendingSatoshi: number, transactionsCount?: number | null } | null } | null }> | null }> } | null };
...
export type CkbBlockQuery = { __typename?: 'Query', ckbBlock?: { __typename?: 'CkbBlock', version: number, hash: string, number: number, timestamp: any, transactionsCount: number, totalFee: number, reward: number, size: number, confirmations: number, miner: { __typename?: 'CkbAddress', address: string, shannon: number, transactionsCount: number } } | null };
