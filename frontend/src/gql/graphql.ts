...
export type BtcChainInfoQuery = { __typename?: 'Query', btcChainInfo: { __typename?: 'BitcoinChainInfo', tipBlockHeight: number, tipBlockHash: string, difficulty: number, transactionsCountIn24Hours: number, fees: { __typename?: 'BitcoinFees', fastest: number, halfHour: number, hour: number, economy: number, minimum: number } }, rgbppStatistic: { __typename?: 'RgbppStatistic', latest24HoursL1TransactionsCount?: number | null } };
...
export type CkbChainInfoQuery = { __typename?: 'Query', ckbChainInfo: { __typename?: 'CkbChainInfo', tipBlockNumber: number, fees: { __typename?: 'CkbFees', fast: number, slow: number, average: number } }, rgbppStatistic: { __typename?: 'RgbppStatistic', latest24HoursL2TransactionsCount?: number | null } };
